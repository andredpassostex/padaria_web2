# padaria_erp_completo_funcional.py
import os
...
for key, default in [
    ...
    ("mostrar_caixa", False), ("mostrar_contas", False),
    ("tela_selecionada", "Dashboard"), ("submenu_selecionado", None)
]:
    ...
    # Funcionários
        ...
        if submenu=="Cadastrar Funcionário":
            ...
            if st.session_state["funcionarios"]:
                ...
                sel = st.selectbox("Escolha o funcionário para remover", nomes, key="sel_rem_func")
    ...
    # Clientes
        ...
        if submenu=="Histórico":
            ...
            if st.session_state["clientes"]:
                ...
                sel_cliente = st.selectbox("Selecione o cliente", nomes_clientes, key="sel_hist_cliente")
            ...
            if st.session_state["clientes"]:
                nomes_clientes = [c.nome for c in st.session_state["clientes"]]
                sel = st.selectbox("Escolha o cliente", nomes_clientes, key="sel_conta_cliente")
...
for item, subs in menu_expansivo.items():
