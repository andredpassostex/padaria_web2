...
produto_existente = next((p for p in st.session_state['produtos'] if p[0].lower() == nome.lower()), None)
...
produto = next((p for p in st.session_state['produtos'] if p[0].lower() == produto_nome.lower()), None)
if produto is None:
